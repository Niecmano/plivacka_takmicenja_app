...
public class PKForma extends javax.swing.JFrame {
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        ...
        PKDijalog pkd = new PKDijalog(this, true, kontroler.vratiKlubove().get(izbor));
        pkd.setVisible(true);
    ...
    private void btnFiltrirajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrirajActionPerformed
        mtpk = new ModelTabelePK(Kontroler.getInstance().
                filtrirajKlubovePoNazivu(tfKlubFilter.getText(),(Mesto) comboMesto.getSelectedItem()));
        jTable1.setModel(mtpk);
